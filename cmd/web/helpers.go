...
// The clientError helper sends a specific status code and corresponding description // to the user. We'll use this later
...
func (app *application) clientError(w http.ResponseWriter, status int) {
	//StatusText returns http status text for given status code rather than 200
